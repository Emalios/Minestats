package fr.emalios.minestats.content.screen;
...
public class FluidRenderer {
    ...
    public static void renderFluid(PoseStack poseStack, int posX, int posY, int width, int height, FluidStack fluidStack) {
        Fluid fluid = fluidStack.getFluid();
        if (fluid == Fluids.EMPTY || fluidStack.isEmpty()) {
            return;
        }
        ...
        drawTiledSprite(poseStack, posX, width, posY, height, fluidColor, sprite);
