...
public class InventoryService {
    ...
    /**
     * Method only used by .create method, do not use it unless for testing purposes
     * @param inventory to load handlers to
     */
    public void addHandlersToInventory(Inventory inventory) {
