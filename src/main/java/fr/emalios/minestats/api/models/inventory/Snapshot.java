...
public class Snapshot implements Comparable<Snapshot> {
    ...
    private final Collection<fr.emalios.minestats.api.models.record.Record> content;
    private final int inventoryId;
    private final long timestamp;

    public Snapshot(int inventoryId, Collection<fr.emalios.minestats.api.models.record.Record> content) {
        this.timestamp = Instant.now().getEpochSecond();
        this.content = content;
        this.inventoryId = inventoryId;
    }

    public Snapshot(int inventoryId, Collection<fr.emalios.minestats.api.models.record.Record> content, long timestamp) {
        this.inventoryId = inventoryId;
        this.content = content;
