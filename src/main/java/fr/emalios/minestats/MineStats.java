package fr.emalios.minestats;

import fr.emalios.minestats.command.StatCommand;
import fr.emalios.minestats.common.MinestatsReloader;
import fr.emalios.minestats.content.block.StatMonitorBlock;
import fr.emalios.minestats.content.item.RecorderItem;
import fr.emalios.minestats.network.ClientPayloadHandler;
import fr.emalios.minestats.network.OpenMonitorMenuPayload;
import fr.emalios.minestats.network.ServerPayloadHandler;
import fr.emalios.minestats.network.StatPayload;
import fr.emalios.minestats.registries.ModMenus;
...
public class MineStats {
    ...
    // Creates a new food item with the id "minestats:example_id", nutrition 1 and saturation 2
    ...
    public MineStats(IEventBus modEventBus, ModContainer modContainer) {
