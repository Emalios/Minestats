...
public class MathTest {
    ...
    @Test
    @DisplayName("Gen by second test")
    public void testGenBySecondMath() throws InterruptedException {
        ...
        var result = StatCalculator.getInstance().genPerSecond(List.of(inv1));
